...
contract PC20Wrapper is ERC20 {
    ...
    constructor(address sourceAsset_, address factory_) ERC20("", "") {
    ...
    function initialize(string calldata name_, string calldata symbol_, uint8 decimals_) external onlyFactory {
