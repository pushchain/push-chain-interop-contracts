...
contract SendPC20UniversalTxTest is BaseTest {
    ...
    function test_EventEmitted() public {
        ...
        emit IUniversalGateway.UniversalTx(
            ...
            address(wrapper),
            100e18,
            abi.encodePacked(PC_20_SELECTOR, abi.encode(sourceAsset)),
            user1,
    ...
    function test_BurnWithPayload() public {
        ...
        emit IUniversalGateway.UniversalTx(
            ...
            address(wrapper),
            100e18,
            abi.encodePacked(PC_20_SELECTOR, abi.encode(sourceAsset), payload),
            user1,
            TX_TYPE.FUNDS_AND_PAYLOAD,
            bytes(""),
            false
    ...
    function test_PC20_PayloadPrefixedWithSelector() public {
        ...
        emit IUniversalGateway.UniversalTx(
            ...
            address(wrapper),
            100e18,
            abi.encodePacked(PC_20_SELECTOR, abi.encode(sourceAsset), userPayload),
            user1,
            TX_TYPE.FUNDS_AND_PAYLOAD,
            bytes(""),
            false
